...
import { NodemcuAmplificador2Service } from 'src/app/service/amplificador2/nodemcu.service';
...
@Component({
  selector: 'app-amplificador2',
  templateUrl: './amplificador2.component.html',
  styleUrls: ['./amplificador2.component.scss'],
})
export class Amplificador2Component implements OnInit, OnDestroy {
  constructor(
    private nodemcuService: NodemcuAmplificador2Service,
    public dialog: MatDialog,
    private mainService: MainAmplificador2Service,
    private modeloService: ModeloAmplificador2Service
  ) {}
