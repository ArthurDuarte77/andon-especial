import { ModeloInversor2Service } from './../../service/inversor2/modelo.service';
...
import { NodemcuInversor2Service } from 'src/app/service/inversor2/nodemcu.service';
...
@Component({
  selector: 'app-inversor2',
  templateUrl: './inversor2.component.html',
  styleUrls: ['./inversor2.component.scss']
})
export class Inversor2Component implements OnInit, OnDestroy {
  constructor(
    private nodemcuService: NodemcuInversor2Service,
    public dialog: MatDialog,
    private mainService: MainInversor2Service,
    private modeloService: ModeloInversor2Service
  ) { }
