...
import { MainAmplificador1Service } from 'src/app/service/amplificador/main.service';
...
@Component({
  selector: 'app-amplificador',
  templateUrl: './amplificador.component.html',
  styleUrls: ['./amplificador.component.scss'],
})
export class AmplificadorComponent implements OnInit, OnDestroy {
  constructor(
    private nodemcuService: NodemcuAmplificador1Service,
    public dialog: MatDialog,
    private mainService: MainAmplificador1Service,
    private modeloService: ModeloAmplificador1Service
  ) {}
