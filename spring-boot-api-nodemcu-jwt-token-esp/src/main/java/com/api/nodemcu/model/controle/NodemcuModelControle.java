...
@Entity
// @Data
@Table(name="thdados_controle")
public class NodemcuModelControle {
    ...
    private ContadorControle contador;
    ...
    public ContadorControle getContador() {
        return contador;
    }

    public void setContador(ContadorControle contador) {
