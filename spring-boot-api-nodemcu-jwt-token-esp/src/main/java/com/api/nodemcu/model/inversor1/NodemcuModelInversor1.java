...
@Entity
// @Data
@Table(name="thdados_inversor1")
public class NodemcuModelInversor1 {
    ...
    private ContadorInversor1 contador;
    ...
    public ContadorInversor1 getContador() {
        return contador;
    }

    public void setContador(ContadorInversor1 contador) {
