...
@Entity
// @Data
@Table(name="thdados_amplificador")
public class NodemcuModelAmplificador {
    ...
    private ContadorAmplificador contador;
    ...
    public ContadorAmplificador getContador() {
        return contador;
    }

    public void setContador(ContadorAmplificador contador) {
