...
public class GeralNodemcuDTOInversor2 {
    private int id;

    private OperationDTOInversor2 nameId; 
    ...
    public OperationDTOInversor2 getNameId() {
        return nameId;
    }

    public void setNameId(OperationDTOInversor2 nameId) {
        this.nameId = nameId;
    }
