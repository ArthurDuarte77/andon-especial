...
public class GeralNodemcuDTOGerenciaveis {
    private int id;

    private OperationDTOGerenciaveis nameId; 
    ...
    public OperationDTOGerenciaveis getNameId() {
        return nameId;
    }

    public void setNameId(OperationDTOGerenciaveis nameId) {
        this.nameId = nameId;
    }
