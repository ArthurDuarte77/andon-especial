...
public class GeralNodemcuDTOAmplificador2 {
    private int id;

    private OperationDTOAmplificador2 nameId; 
    ...
    public OperationDTOAmplificador2 getNameId() {
        return nameId;
    }

    public void setNameId(OperationDTOAmplificador2 nameId) {
        this.nameId = nameId;
    }
