...
public class GeralNodemcuDTOInversor1 {
    private int id;

    private OperationDTOInversor1 nameId; 
    ...
    public OperationDTOInversor1 getNameId() {
        return nameId;
    }

    public void setNameId(OperationDTOInversor1 nameId) {
        this.nameId = nameId;
    }
