...
public class GeralNodemcuDTOAmplificador {
    private int id;

    private OperationDTOAmplificador nameId; 
    ...
    public OperationDTOAmplificador getNameId() {
        return nameId;
    }

    public void setNameId(OperationDTOAmplificador nameId) {
        this.nameId = nameId;
    }
