...
public class GeralNodemcuDTOControle {
    private int id;

    private OperationDTOControle nameId; 
    ...
    public OperationDTOControle getNameId() {
        return nameId;
    }

    public void setNameId(OperationDTOControle nameId) {
        this.nameId = nameId;
    }
