...
@Entity
// @Data
@Table(name="thdados_inversor2")
public class NodemcuModelInversor2 {
    ...
    private ContadorInversor2 contador;
    ...
    public ContadorInversor2 getContador() {
        return contador;
    }

    public void setContador(ContadorInversor2 contador) {
