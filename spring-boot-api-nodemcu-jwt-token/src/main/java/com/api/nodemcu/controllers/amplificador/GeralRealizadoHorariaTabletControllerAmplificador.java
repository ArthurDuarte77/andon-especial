...
@RestController
@RequestMapping("/api/v1/geral/realizadoHorariaTablet_amplificador")
public class GeralRealizadoHorariaTabletControllerAmplificador {

    @Autowired
    private GeralRealizadoHorariaTabletRepositoryAmplificador geralRealizadoHorariaTabletRepository;

    @GetMapping("/filterByDate")
    public List<GeralRealizadoHorariaTabletModelAmplificador> filterByDate(@RequestParam("startDate") String startDate,
        ...
        try {
            ...
            List<GeralRealizadoHorariaTabletModelAmplificador> allRecords = geralRealizadoHorariaTabletRepository.findAll();
    ...
    @GetMapping()
    public List<GeralRealizadoHorariaTabletModelAmplificador> findAll() {
