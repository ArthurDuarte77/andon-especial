...
@RestController
@RequestMapping("/api/v1/geral/realizadoHorariaTablet_amplificador2")
public class GeralRealizadoHorariaTabletControllerAmplificador2 {

    @Autowired
    private GeralRealizadoHorariaTabletRepositoryAmplificador2 geralRealizadoHorariaTabletRepository;

    @GetMapping("/filterByDate")
    public List<GeralRealizadoHorariaTabletModelAmplificador2> filterByDate(@RequestParam("startDate") String startDate,
        ...
        try {
            ...
            List<GeralRealizadoHorariaTabletModelAmplificador2> allRecords = geralRealizadoHorariaTabletRepository.findAll();
    ...
    @GetMapping()
    public List<GeralRealizadoHorariaTabletModelAmplificador2> findAll() {
