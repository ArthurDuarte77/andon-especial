...
@RestController
@RequestMapping("/api/v1/geral/realizadoHorariaTablet_gerenciaveis")
public class GeralRealizadoHorariaTabletControllerGerenciaveis {

    @Autowired
    private GeralRealizadoHorariaTabletRepositoryGerenciaveis geralRealizadoHorariaTabletRepository;

    @GetMapping("/filterByDate")
    public List<GeralRealizadoHorariaTabletModelGerenciaveis> filterByDate(@RequestParam("startDate") String startDate,
        ...
        try {
            ...
            List<GeralRealizadoHorariaTabletModelGerenciaveis> allRecords = geralRealizadoHorariaTabletRepository.findAll();
    ...
    @GetMapping()
    public List<GeralRealizadoHorariaTabletModelGerenciaveis> findAll() {
