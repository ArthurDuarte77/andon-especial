...
@RestController
@RequestMapping("/api/v1/geral/realizadoHorariaTablet_inversor1")
public class GeralRealizadoHorariaTabletControllerInversor1 {

    @Autowired
    private GeralRealizadoHorariaTabletRepositoryInversor1 geralRealizadoHorariaTabletRepository;

    @GetMapping("/filterByDate")
    public List<GeralRealizadoHorariaTabletModelInversor1> filterByDate(@RequestParam("startDate") String startDate,
        ...
        try {
            ...
            List<GeralRealizadoHorariaTabletModelInversor1> allRecords = geralRealizadoHorariaTabletRepository.findAll();
    ...
    @GetMapping()
    public List<GeralRealizadoHorariaTabletModelInversor1> findAll() {
