...
import { OperationService } from 'src/app/service/inversorl2/operation.service';
import { WebsocketService } from 'src/app/service/inversorl2/websocket.service';

@Component({
  selector: 'app-inversorl2',
  templateUrl: './inversorl2.component.html',
  styleUrls: ['./inversorl2.component.scss']
})
export class Inversorl2Component implements OnInit, OnDestroy, AfterViewInit {
