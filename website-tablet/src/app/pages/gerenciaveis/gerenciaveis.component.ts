...
import { OperationService } from 'src/app/service/gerenciaveis/operation.service';
import { WebsocketService } from 'src/app/service/gerenciaveis/websocket.service';
...
export class GerenciaveisComponent implements OnInit, OnDestroy, AfterViewInit {
