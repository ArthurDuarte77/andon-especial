...
import { OperationService } from 'src/app/service/amplificadorl2/operation.service';
import { WebsocketService } from 'src/app/service/amplificadorl2/websocket.service';

@Component({
  selector: 'app-amplificadorl2',
  templateUrl: './amplificadorl2.component.html',
  styleUrls: ['./amplificadorl2.component.scss']
})
export class Amplificadorl2Component implements OnInit, OnDestroy, AfterViewInit {
