...
import { OperationService } from 'src/app/service/controle/operation.service';
import { WebsocketService } from 'src/app/service/controle/websocket.service';
...
export class ControleComponent implements OnInit, OnDestroy, AfterViewInit {
